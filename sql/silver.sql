...
DROP TABLE IF EXISTS silver.prd_cate;

CREATE TABLE silver.prd_cate(
    id VARCHAR(10),
    cat VARCHAR(20),
    subcat VARCHAR(20),
...
TRUNCATE TABLE silver.prd_cate;

INSERT INTO silver.prd_cate(
id,
cat,
subcat,
maintenance
...
DROP TABLE IF EXISTS silver.cust_loc;

CREATE TABLE silver.cust_loc(
    cid VARCHAR(20),
    cntry VARCHAR(20)
);

SELECT '==================== LOADING DATA INTO cust_loc';
TRUNCATE TABLE silver.cust_loc;

INSERT INTO silver.cust_loc(
cid,
cntry
)
SELECT
...
DROP TABLE IF EXISTS silver.cust_per_info;

CREATE TABLE silver.cust_per_info (
    cid VARCHAR(20),
    bdate DATE,
    gen VARCHAR(10)
);
...
TRUNCATE TABLE silver.cust_per_info;

INSERT INTO silver.cust_per_info(
cid,
bdate,
gen
)
